...
export const UNSUPPORTED_ARGUMENT_ERROR = '[vue-js-modal] ' + '$modal() received an unsupported argument as a first argument.'

export const HIDE_ALL_RESTRICTION_ERROR =
  '[vue-js-modal] ' + '$modal.hideAll() call will be ignored because dynamic modals are not enabled.'
