export default {
  ...
  phEnterVerificationCode: 'Verification Code',
  ...
  partnerRule:
    'eg: <br/> Player A 1st deposit <span style="color:var(--norm_red-color)">{0}</span> and turnover <span style="color:var(--norm_red-color)">{1}</span>, you can\'t get bonus',
  ...
  gameT: 'Game requires recharge {0} to enter',
  sxf: 'Amount range <span class="red">{0}-{1}</span> withdrawal fee available',
  sxf1: 'Withdrawal fee <span class="red">{0}%</span>',
  nw1: 'Remaining betting time: ',
  nw2: 'The last 10 prize draws',
  nw3: 'Current issue number:',
  nw4: 'No betting allowed during the draw time',
  nw5: 'This issue betting:',
  nw6: 'Previous Prize Draws',
  nw7: 'Betting History',
  nw8: 'No bets yet',
}
