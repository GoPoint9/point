...
function getIcon (key: string, index: number) {
  return getIcons('home/gameListIcons', `${index === active.value ? key : key + 'Active'}`)
}
...
const onChange = (e: any) => {
  ...
  // if (gameType.key === 'popular') {
  // 	hotSlotList.value = gameList[e].gameList[0]
  // 	slotList.value = gameList[e].gameList[1]
  // } else {
  // 	slotList.value = gameList[e].gameList
  // }
}
