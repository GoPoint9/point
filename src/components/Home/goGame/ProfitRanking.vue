<template>
  <div class="mainContainer">
    <div v-for="(item, index) in homeState.rankList.slice(0, 9)" :key="item" class="mainContainer_profitContainer">
      <!-- Rank 1 -->
      <div v-if="index == 0" class="mainContainer_profitContainer_medal">
        <span><img src="./imgs/First.png"></span>
      </div>
      <!-- Rank 2 -->
      <div v-else-if="index == 1" class="mainContainer_profitContainer_medal">
        <span><img src="./imgs/Second.png"></span>
      </div>
      <!-- Rank 3 -->
      <div v-else-if="index == 2" class="mainContainer_profitContainer_medal">
        <span><img src="./imgs/Third.png"></span>
      </div>
      <!-- Rank All -->
      <div v-else class="mainContainer_profitContainer_medal">
        <span class="numberMedal">{{ index + 1 }}</span>
      </div>
      <div class="mainContainer_profitContainer_img"><img v-lazy="getIconsPublic('main/Avatar', item.userPhoto)"></div>
      <div class="mainContainer_profitContainer_title">{{ desensitizeString(item['nickName']) }}</div>
      <div class="mainContainer_profitContainer_amount">{{ currency(item['amount'] || 0) }}</div>
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_backgroundBlur_2662_26708"
                result="shape"
              />
            </filter>
          </defs>
